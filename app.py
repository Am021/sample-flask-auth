...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pysql:///root:admin123@127.0.0.1:3306'
...
def login():
    ...
    if username and password: #Confirimos se as informações foram recebidas
        ...
        if user and bcrypt.checkpw(str.encode(password), str.encode(user.password)): #Verificamos se o usuário existe e se a senha fornecida corresponde à senha armazenada no banco de dados. Se ambas as condições forem verdadeiras, o usuário é autenticado com sucesso.
